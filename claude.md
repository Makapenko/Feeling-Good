...
│       ├── book2/
│       │   ├── chapters/     # HTML-файлы глав (Книга 2 — Близость)
...
- **Две книги**: "Терапия настроения" (19 глав) и "Близость" (14 глав + приложения)
...
- ✅ Двумя книгами: "Терапия настроения" и "Близость"
