...
**Feeling Good** — это веб-приложение для самопомощи на основе когнитивно-поведенческой терапии (КПТ), основанное на методологии Дэвида Бернса. Приложение предоставляет структурированный курс с главами и 37 терапевтическими упражнениями для борьбы с депрессией и улучшения психологического состояния.
...
│   │   ├── ListOfChapters/  # Навигация по главам (сайдбар)
...
### 3.1 Система управления главами

- **Последовательная прогрессия**: Главы открываются по мере прохождения
- **Иерархическая структура**: Разделы и подразделы
- **HTML контент**: Главы загружаются из `/public/content/chapters/`
...
- Контент глав в HTML формате находится в `/public/content/chapters/`
- Изображения в `/public/content/images/`
...
- ✅ Структурированным курсом с последовательными главами
