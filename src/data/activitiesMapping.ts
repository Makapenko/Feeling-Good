...
export const chapterToActivitiesMap: Record<string, SpecialContent[]> = {
  'ch2': ['burns-checklist'], // Оставляем, так как это одиночная глава
  'ch3-1': ['cognitive-biases', 'cognitive-biases-test'],
  'ch4-1': ['three-columns-method'],
  'ch4-2': ['thought-diary'],
  ...
  'ch6-2': ['disarming-technique'],
  'ch7-1': ['novaco-scale'],
  'ch13-2': ['imagine-success', 'count-achievements'],
  'ch13-3': ['check-cant-do'],
  'ch13-4': ['no-lose-technique']
};
