...
export const ACTIVITY_IDS = {
  ...
  LONELINESS_SCALE: 'loneliness-scale',
  INTIMACY_SCALE: 'intimacy-scale',
  LONELINESS_PLEASURE_SHEET: 'loneliness-pleasure-sheet',
...
export const ACTIVITY_NAMES: Record<ActivityId, string> = {
  ...
  [ACTIVITY_IDS.LONELINESS_SCALE]: 'Опросник одиночества',
  [ACTIVITY_IDS.INTIMACY_SCALE]: 'Тест на способность к близости',
  [ACTIVITY_IDS.LONELINESS_PLEASURE_SHEET]: 'Бланк предполагаемого удовольствия (одиночество)',
  [ACTIVITY_IDS.MOOD_JOURNAL]: 'Журнал настроения',
